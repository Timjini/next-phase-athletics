...
export function ModernHero() {
  ...
  return (
    <div
      className="h-[40rem] bg-cover w-full min-h-screen rounded-md flex md:items-center md:justify-center bg-black/[0.96] antialiased bg-grid-white/[0.02] relative overflow-hidden"
