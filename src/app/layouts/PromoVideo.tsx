...
const PromoVideoSection = () => {
  ...
  return (
    <section className="promoSection bg-gradient-to-b from-[#0046CC] to-[#09131D]  ">
           <div className="min-h-screen promoSection relative gap-8 items-center py-16 px-8 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-1 sm:py-16 lg:px-6">
